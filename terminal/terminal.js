...
var Terminal = (function () {
	...
	var TerminalConstructor = function (id) {
		...
		this.printSlow = function (message, textColor) {
			return new Promise((resolve, reject) => {
				var newLine = document.createElement('div')
				if (textColor) {
					newLine.style.color = textColor;
				}
				let i = 0;
				let out = setInterval(() => {
		...
		this.printSameLine = function (message, textColor) {
			var sameLine = document.createElement('span')
			sameLine.textContent = message;
			if (textColor) {
				sameLine.style.color = textColor;
			}
			this._output.appendChild(sameLine);
		}
